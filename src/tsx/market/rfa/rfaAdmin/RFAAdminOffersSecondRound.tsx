...
import "./rfaAdminOffersSecondRound.css";
import { supabase } from "../../../../Supabase";

interface RFAOfferSecondRound {
  team: string;
  player: string;
...
const RFAAdminOffersSecondRound = () => {
  const [offers, setOffers] = useState<RFAOfferSecondRound[]>([]);
  ...
  if (loading)
    return (
      <div className="rfaAdminOffersSecondRound-loading">
        Загрузка данных...
      </div>
    );
  if (error)
    return (
      <div className="rfaAdminOffersSecondRound-error">Ошибка: {error}</div>
    );

  return (
    <div className="rfaAdminOffersSecondRound">
      <h2 className="rfaAdminOffersSecondRound-title">
        Предложения RFA (второй раунд)
      </h2>

      <div className="rfaAdminOffersSecondRound-filtersPanel">
        <div className="rfaAdminOffersSecondRound-filterGroup">
          <label
            htmlFor="team-filter"
            className="rfaAdminOffersSecondRound-filterLabel"
          >
            Фильтр по команде:
          </label>
          <input
            ...
            className="rfaAdminOffersSecondRound-filterInput"
        ...
        <button
          ...
          className="rfaAdminOffersSecondRound-clearFiltersBtn"
          aria-label="Сбросить все фильтры и сортировку"
        >
          Сбросить фильтры
        </button>

        <div className="rfaAdminOffersSecondRound-resultsCount">
          Найдено: {filteredAndSortedOffers.length} из {offers.length}
        </div>
      </div>

      <div className="rfaAdminOffersSecondRound-tableWrapper">
        <table className="rfaAdminOffersSecondRound-table">
          <thead>
            <tr>
              <th
                onClick={() => handleSort("team")}
                className="rfaAdminOffersSecondRound-sortableHeader"
                aria-label="Сортировать по команде"
              >
                <span className="rfaAdminOffersSecondRound-headerContent">
                  Команда{" "}
              ...
              <th className="rfaAdminOffersSecondRound-header">
                <span className="rfaAdminOffersSecondRound-headerContent">
                  Тип контракта
                </span>
              </th>
            ...
            {filteredAndSortedOffers.length > 0 ? (
              filteredAndSortedOffers.map((offer, index) => (
                <tr
                  ...
                  className="rfaAdminOffersSecondRound-tableRow"
                >
                  <td
                    className="rfaAdminOffersSecondRound-tableCell"
                    data-label="Команда"
                  >
                    {offer.team}
                  </td>
              ...
              <tr className="rfaAdminOffersSecondRound-tableRow">
                <td
                  colSpan={13}
                  className="rfaAdminOffersSecondRound-noDataCell"
                >
...
export default RFAAdminOffersSecondRound;
