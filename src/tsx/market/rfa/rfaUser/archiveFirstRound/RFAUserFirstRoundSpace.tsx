...
import "./rfaUserFirstRoundSpace.css";
  ...
  const handleSubmit = useCallback(async (): Promise<void> => {
    ...
    try {
      ...
      const dataToInsert = {
        ...
        salary: parseInt(contractAmount.replace(/\s/g, ""), 10), // Убираем пробелы и преобразуем в число
        ...
        bonus: bonusPercentage ? Math.round(parseFloat(bonusPercentage)) : null, // Округляем до целого числа
        condition:
