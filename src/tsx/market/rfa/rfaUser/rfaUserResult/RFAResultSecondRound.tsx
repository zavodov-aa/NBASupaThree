...
import "./rfaResultSecondRound.css";

const RFAResultSecondRound = () => {
  ...
  const fetchRFAResults = async () => {
    ...
    try {
      const { data, error } = await supabase
        ...
        .eq("rfa_second_round_result", selectedTeam);

      if (error) throw error;

      // Дополнительная фильтрация для надёжности
  ...
  return (
    <div style={{ padding: "20px" }}>
      ...
      >
        Выбор команды NBA — Второй раунд RFA
      </h2>
              ...
              {passwordVerified === true && (
                ...
                >
                  ...
                  >
                    {loadingPlayers
                      ? "Загрузка..."
                      : "Показать результаты 2 раунда RFA"}
                  </button>
...
export default RFAResultSecondRound;
