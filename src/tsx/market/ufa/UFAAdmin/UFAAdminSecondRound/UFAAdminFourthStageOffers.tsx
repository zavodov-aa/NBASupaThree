...
import "./ufaAdminFourthStageOffers.css";
import { supabase } from "../../../../../Supabase";

interface UFAFourthStageOffer {
  team: string;
  player: string;
...
const UFAAdminFourthStageOffers = () => {
  const [offers, setOffers] = useState<UFAFourthStageOffer[]>([]);
  ...
  if (loading)
    return (
      <div className="ufaAdminFourthStageOffers-loading">
        Загрузка данных...
      </div>
    );
  if (error)
    return (
      <div className="ufaAdminFourthStageOffers-error">Ошибка: {error}</div>
    );

  return (
    <div className="ufaAdminFourthStageOffers">
      <h2 className="ufaAdminFourthStageOffers-title">
        Предложения UFA (четвертый этап второго раунда)
      </h2>

      <div className="ufaAdminFourthStageOffers-filtersPanel">
        <div className="ufaAdminFourthStageOffers-filterGroup">
          <label
            htmlFor="team-filter"
            className="ufaAdminFourthStageOffers-filterLabel"
          >
            Фильтр по команде:
          </label>
          <input
            ...
            className="ufaAdminFourthStageOffers-filterInput"
        ...
        <button
          ...
          className="ufaAdminFourthStageOffers-clearFiltersBtn"
          aria-label="Сбросить все фильтры и сортировку"
        >
          Сбросить фильтры
        </button>

        <div className="ufaAdminFourthStageOffers-resultsCount">
          Найдено: {filteredAndSortedOffers.length} из {offers.length}
        </div>
      </div>

      <div className="ufaAdminFourthStageOffers-tableWrapper">
        <table className="ufaAdminFourthStageOffers-table">
          <thead>
            <tr>
              <th
                onClick={() => handleSort("team")}
                className="ufaAdminFourthStageOffers-sortableHeader"
                aria-label="Сортировать по команде"
              >
                <span className="ufaAdminFourthStageOffers-headerContent">
                  Команда{" "}
              ...
              <th className="ufaAdminFourthStageOffers-header">
                <span className="ufaAdminFourthStageOffers-headerContent">
                  Тип контракта
                </span>
              </th>
            ...
            {filteredAndSortedOffers.length > 0 ? (
              filteredAndSortedOffers.map((offer, index) => (
                <tr
                  ...
                  className="ufaAdminFourthStageOffers-tableRow"
                >
                  <td
                    className="ufaAdminFourthStageOffers-tableCell"
                    data-label="Команда"
                  >
                    {offer.team}
                  </td>
              ...
              <tr className="ufaAdminFourthStageOffers-tableRow">
                <td
                  colSpan={13}
                  className="ufaAdminFourthStageOffers-noDataCell"
                >
...
export default UFAAdminFourthStageOffers;
