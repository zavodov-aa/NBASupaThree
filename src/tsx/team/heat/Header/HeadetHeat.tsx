...
import "./headerHeat.css";
import logo from "../../../../img/LogoLeague4kFinal.png";
import HamburgerMenu from "./HamburgerMenuHeat";

interface HeaderHeatProps {
...
const HeaderHeat: React.FC<HeaderHeatProps> = ({
  onScrollToRoster,
  onScrollToTrades,
  onScrollToDeadCap,
  // onScrollToGLeague,
  ...
  return (
    <div className="headerHeat">
      <a href="/" style={{ display: "contents" }}>
        <img className="headerLogoHeat" src={logo} alt="" />
      </a>
      <div>
        <nav className="headerNavHeat">
          <a
            href="#roster"
            className="headerNavLinkHeat"
