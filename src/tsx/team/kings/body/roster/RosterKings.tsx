        ...
        <table className="roster-tableKings">
          <tbody>
            {players.map((player, index) => (
              <tr
                key={player.id}
                className={player.id === 1 ? "franchiseKings" : ""}
              >
                <td>
                  <div className="number-cellKings">
                    {index + 0}
                    {player.id === 1 && <span className="starKings">★</span>}
                  </div>
                </td>
                <td>
                  <span className="player-tagKings ">
                ...
                <td>{player.age || "—"}</td>
                <td className="highlightKings">{player.year_one || "—"}</td>
