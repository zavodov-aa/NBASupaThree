    ...
    <div className="rosterNets">
        ...
        <table className="roster-tableNets">
          <tbody>
            {players.map((player, index) => (
              <tr
                key={player.id}
                className={player.id === 1 ? "franchiseNets" : ""}
              >
                <td>
                  <div className="number-cellNets">
                    {index + 0}
                    {player.id === 1 && <span className="starNets">★</span>}
                  </div>
                </td>
                <td>
                  <span className="player-tagNets ">
                ...
                <td>{player.age || "—"}</td>
                <td className="highlightNets">{player.year_one || "—"}</td>
      ...
      {players.length === 0 && (
        <div className="empty-stateNets">
          <div className="empty-iconNets">🏀</div>
