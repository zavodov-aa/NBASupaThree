...
import "./headerPacers.css";
import logo from "../../../../img/LogoLeague4kFinal.png";
import HamburgerMenu from "./HamburgerMenuPacers";

interface HeaderPacersProps {
...
const HeaderPacers: React.FC<HeaderPacersProps> = ({
  onScrollToRoster,
  onScrollToTrades,
  onScrollToDeadCap,
  // onScrollToGLeague,
  ...
  return (
    <div className="headerPacers">
      <a href="/" style={{ display: "contents" }}>
        <img className="headerLogoPacers" src={logo} alt="" />
      </a>
      <div>
        <nav className="headerNavPacers">
          <a
            href="#roster"
            className="headerNavLinkPacers"
