...
import "./headerRaptors.css";
import logo from "../../../../img/LogoLeague4kFinal.png";
import HamburgerMenu from "./HamburgerMenuRaptors";

interface HeaderRaptorsProps {
...
const HeaderRaptors: React.FC<HeaderRaptorsProps> = ({
  onScrollToRoster,
  onScrollToTrades,
  onScrollToDeadCap,
  // onScrollToGLeague,
  ...
  return (
    <div className="headerRaptors">
      <a href="/" style={{ display: "contents" }}>
        <img className="headerLogoRaptors" src={logo} alt="" />
      </a>
      <div>
        <nav className="headerNavRaptors">
          <a
            href="#roster"
            className="headerNavLinkRaptors"
