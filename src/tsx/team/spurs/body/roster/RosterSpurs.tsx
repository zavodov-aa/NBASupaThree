        ...
        <table className="roster-tableSpurs">
          <tbody>
            {players.map((player, index) => (
              <tr
                key={player.id}
                className={player.id === 1 ? "franchiseSpurs" : ""}
              >
                <td>
                  <div className="number-cellSpurs">
                    {index + 0}
                    {player.id === 1 && <span className="starSpurs">★</span>}
                  </div>
                </td>
                <td>
                  <span className="player-tagSpurs ">
                ...
                <td>{player.age || "—"}</td>
                <td className="highlightSpurs">{player.year_one || "—"}</td>
