...
import "./headerSpurs.css";
import logo from "../../../../img/LogoLeague4kFinal.png";
import HamburgerMenu from "./HamburgerMenuSpurs";

interface HeaderSpursProps {
...
const HeaderSpurs: React.FC<HeaderSpursProps> = ({
  onScrollToRoster,
  onScrollToTrades,
  onScrollToDeadCap,
  // onScrollToGLeague,
  ...
  return (
    <div className="headerSpurs">
      <a href="/" style={{ display: "contents" }}>
        <img className="headerLogoSpurs" src={logo} alt="" />
      </a>
      <div>
        <nav className="headerNavSpurs">
          <a
            href="#roster"
            className="headerNavLinkSpurs"
