        ...
        <table className="roster-tableWarriors">
          <tbody>
            {players.map((player, index) => (
              <tr
                key={player.id}
                className={player.id === 1 ? "franchiseWarriors" : ""}
              >
                <td>
                  <div className="number-cellWarriors">
                    {index + 0}
                    {player.id === 1 && <span className="starWarriors">★</span>}
                  </div>
                </td>
                <td>
                  <span className="player-tagWarriors ">
                ...
                <td>{player.age || "—"}</td>
                <td className="highlightWarriors">{player.year_one || "—"}</td>
